...
while(rr.next()){
		...
		{
	         lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("dress.jpg")));
                contentPane.add(lblNewLabel);
			
		}
		else if(prod.equals("Top"))
		{
			lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("top.jpg")));
                contentPane.add(lblNewLabel);
		}
		else if(prod.equals("Trouser"))
		{
			lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("trouser.jpg")));
                contentPane.add(lblNewLabel);
		}
		else if(prod.equals("Jeans"))
		{
			lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("jeans.jpg")));
                contentPane.add(lblNewLabel);
		}
		else if(prod.equals("Jumpsuit"))
		{
			lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("jumpsuit.jpg")));
                contentPane.add(lblNewLabel);
		}
		else if(prod.equals("Sweater"))
		{
			lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("sweater.jpg")));
                contentPane.add(lblNewLabel);
		}
		else if(prod.equals("Shirt")&&cid==112)
		{
			lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("shirt.jpg")));
                contentPane.add(lblNewLabel);
		}
		else if(prod.equals("Tee shirt"))
		{
			lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("tshirt.jpg")));
                contentPane.add(lblNewLabel);
		}
		else if(prod.equals("Trouser")&&cid==112)
		{
			lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("trouserm.jpg")));
                contentPane.add(lblNewLabel);
		}
		else if(prod.equals("Jeans")&&cid==112)
		{
			lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("jeansm.jpg")));
                contentPane.add(lblNewLabel);
		}
		else if(prod.equals("Tuxedo")&&cid==112)
		{
			lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("tuxedo.jpg")));
                contentPane.add(lblNewLabel);
		}
		else if(prod.equals("Sweater")&&cid==112)
		{
			lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("sweaterm.jpg")));
                contentPane.add(lblNewLabel);
		}
		else if(prod.equals("Frock"))
		{
			lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("frock.jpg")));
                contentPane.add(lblNewLabel);
		}
		else if(prod.equals("Baby Suit"))
		{
			lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("babysuit.jpg")));
                contentPane.add(lblNewLabel);
		}
		else if(prod.equals("Fancy Clothes"))
		{
			lblNewLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("fancy.jpg")));
                contentPane.add(lblNewLabel);
		}
